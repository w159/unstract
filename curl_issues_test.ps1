...
$session.Cookies.Add((New-Object System.Net.Cookie("XSRF-TOKEN", "oqk490rl9j7t7v3jad3dkhfblk", "/", ".sonarcloud.io")))
$session.Cookies.Add((New-Object System.Net.Cookie("JWT-SESSION", "eyJhbGciOiJIUzI1NiJ9.eyJsYXN0UmVmcmVzaFRpbWUiOjE3NTA0NzUzOTM2MzksInhzcmZUb2tlbiI6Im9xazQ5MHJsOWo3dDd2M2phZDNka2hmYmxrIiwianRpIjoiQVplUWNqWHduMjRnVXdDRjRSWDUiLCJzdWIiOiJBWmVRY1hYNmRwY1kxR1I1NU9qUiIsImlhdCI6MTc1MDQ3NTA5MywiZXhwIjoxNzUwNTYxNzkzfQ.5vlAUZ85pemE4BTqYOSlnfSprFWr4GPMpnn5-kaGov0", "/", ".sonarcloud.io")))
$request = Invoke-WebRequest -UseBasicParsing -Uri "https://sonarcloud.io/api/issues/search?s=FILE_LINE&issueStatuses=OPEN%2CCONFIRMED&ps=100&componentKeys=w159_unstract&organization=w159&p=2&additionalFields=_all" `
-WebSession $session `
-Headers @{
"authority"="sonarcloud.io"
  ...
  "sec-gpc"="1"
  "x-xsrf-token"="oqk490rl9j7t7v3jad3dkhfblk"
}
